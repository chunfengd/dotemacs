...
- [[#todolist-05][todolist]]
  - [[#straight][straight]]
  - [[#yank-word][yank-word]]
  - [[#use-emacsdinitel][use .emacs.d/init.el]]
...
(setq package-archives
      '(
        ;; ("cf-melpa" . ,(my/path "../cf-melpa/packages"))
...
#+END_SRC
** TODO use toc-org to automatically generate a table of contents for org files.
#+BEGIN_SRC emacs-lisp
(defun my/setup-toc-org ()
...
(defun my/web-mode-setup ()
  ...
  (defun my/web-mode-func()
    ...
    (my/set-key-bindings
     ...
     web-mode-map))
  (add-hook 'web-mode-hook 'my/web-mode-func))
...
(defun my/term-mode-hook-func ()
  ...
  (my/set-key-bindings
   ...
   term-raw-map))
(add-hook 'term-mode-hook 'my/term-mode-hook-func)
#+END_SRC
** tm function
#+BEGIN_SRC emacs-lisp
(defun tm ()
...
- https://emacs.stackexchange.com/questions/76463/cant-use-isearch-yank-word-or-char-in-minibuffer-local-map
** TODO use .emacs.d/init.el
