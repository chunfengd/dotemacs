...
- [[#key-binding][key binding]]
  ...
  - [[#mac-key][mac key]]
  - [[#evil-custom-text-object][evil custom text object]]
  - [[#evil][evil]]
...
- [[#plantuml][plantuml]]
  ...
  - [[#setup][setup]]
- [[#gnuplot][gnuplot]]
  - [[#setup-org-babel-for-gnuplot][setup org babel for gnuplot]]
  - [[#setup-1][setup]]
- [[#python][python]]
  - [[#setup-2][setup]]
...
#+end_src
** examples
**** consult-ripgrep and add file path filter
#+begin_src sh :tangle no
### ripgrep
# ripgrep search only in plans.org
<spc> v r --> cftask -- -g plans.org
# ripgrep with exclude
<spc> v r --> cftask -- -g !logs.org

### grep
<spc> v g --> cftask -- --include plans.org
#+end_src
**** to ignore some files by default
- =.gitignore=: for rg & git
- =.rgignore=: for rg but not for grep
* projectile
#+begin_src emacs-lisp
...
** vterm
*** install libvterm
This requires libvterm to be installed
#+begin_src sh :tangle no
  # on mac
