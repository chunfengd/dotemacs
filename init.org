...
#+begin_src emacs-lisp :tangle no
(defvar original-org-babel-execute:C++ nil "the real function")
(add-hook 'org-mode-hook
          (lambda ()
            (unless (fboundp 'original-org-babel-execute:C++)
              (fset 'original-org-babel-execute:C++ 'org-babel-execute:C++)
